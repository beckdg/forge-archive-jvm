...
public static SyncSession fromBytes(byte[] data) throws ForgeFormatException {
    SyncSession instance = new SyncSession();
    instance.parse(data);
    return instance;
}
