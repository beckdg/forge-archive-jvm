...
public byte[] encode() {
    ...
    scratch.writeUtf8("SyncManifest");
...
public static SyncManifest fromBytes(byte[] data) throws ForgeFormatException {
    SyncManifest instance = new SyncManifest();
    instance.parse(data);
    return instance;
}
