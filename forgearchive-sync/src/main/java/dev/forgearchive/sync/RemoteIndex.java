...
public final class RemoteIndex {
...
public static RemoteIndex fromBytes(byte[] data) throws ForgeFormatException {
    RemoteIndex instance = new RemoteIndex();
    instance.parse(data);
    return instance;
}
