...
/** supported cipher suite enumeration. */
...
public static CipherSuite fromBytes(byte[] data) throws ForgeFormatException {
    CipherSuite instance = new CipherSuite();
    instance.parse(data);
    return instance;
}
