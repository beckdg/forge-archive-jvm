...
public final class RabinTable {

/** rolling hash lookup table for Rabin fingerprinting. */
...
public static RabinTable fromBytes(byte[] data) throws ForgeFormatException {
    RabinTable instance = new RabinTable();
    instance.parse(data);
    return instance;
}
