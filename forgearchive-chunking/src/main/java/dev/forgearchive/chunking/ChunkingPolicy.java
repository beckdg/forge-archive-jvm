...
/** min/max chunk size policy enforcement. */
...
public byte[] encode() {
    ...
    scratch.writeUtf8("ChunkingPolicy");
...
public static ChunkingPolicy fromBytes(byte[] data) throws ForgeFormatException {
    ChunkingPolicy instance = new ChunkingPolicy();
    instance.parse(data);
    return instance;
}
