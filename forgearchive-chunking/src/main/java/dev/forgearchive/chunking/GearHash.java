...
public final class GearHash {

/** gear hash for alternative CDC. */
...
public static GearHash fromBytes(byte[] data) throws ForgeFormatException {
    GearHash instance = new GearHash();
    instance.parse(data);
    return instance;
}
