...
public final class ChunkBoundaryDetector {
...
public ChunkBoundaryDetector() { }

public byte[] encode() {
    scratch.reset();
    scratch.writeInt(ForgeVersions.PROTOCOL_VERSION);
    scratch.writeUtf8("ChunkBoundaryDetector");
...
public static ChunkBoundaryDetector fromBytes(byte[] data) throws ForgeFormatException {
    ChunkBoundaryDetector instance = new ChunkBoundaryDetector();
    instance.parse(data);
    return instance;
}
