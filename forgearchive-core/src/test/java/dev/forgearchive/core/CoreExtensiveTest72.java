...
class CoreExtensiveTest72 {

    @Test
    void testVarIntRoundtrip72() throws Exception {
        int v = 9145;
    ...
    @Test
    void testContentHash72() {
        byte[] data = ("payload72").getBytes();
    ...
    void testHexRoundtrip72(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (72 + j);
