...
class CoreExtensiveTest39 {

    @Test
    void testVarIntRoundtrip39() throws Exception {
        int v = 4954;
    ...
    @Test
    void testContentHash39() {
        byte[] data = ("payload39").getBytes();
    ...
    void testHexRoundtrip39(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (39 + j);
