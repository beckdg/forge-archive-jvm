...
class CoreExtensiveTest35 {

    @Test
    void testVarIntRoundtrip35() throws Exception {
        int v = 4446;
    ...
    @Test
    void testContentHash35() {
        byte[] data = ("payload35").getBytes();
    ...
    void testHexRoundtrip35(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (35 + j);
