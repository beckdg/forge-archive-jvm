...
class CoreExtensiveTest25 {

    @Test
    void testVarIntRoundtrip25() throws Exception {
        int v = 3176;
    ...
    @Test
    void testContentHash25() {
        byte[] data = ("payload25").getBytes();
    ...
    void testHexRoundtrip25(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (25 + j);
