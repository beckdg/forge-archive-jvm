...
class CoreExtensiveTest6 {

    @Test
    void testVarIntRoundtrip6() throws Exception {
        int v = 763;
    ...
    @Test
    void testContentHash6() {
        byte[] data = ("payload6").getBytes();
    ...
    void testHexRoundtrip6(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (6 + j);
