...
class CoreExtensiveTest37 {

    @Test
    void testVarIntRoundtrip37() throws Exception {
        int v = 4700;
    ...
    @Test
    void testContentHash37() {
        byte[] data = ("payload37").getBytes();
    ...
    void testHexRoundtrip37(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (37 + j);
