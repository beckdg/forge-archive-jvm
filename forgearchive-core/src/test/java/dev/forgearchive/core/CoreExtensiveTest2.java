...
class CoreExtensiveTest2 {

    @Test
    void testVarIntRoundtrip2() throws Exception {
        int v = 255;
    ...
    @Test
    void testContentHash2() {
        byte[] data = ("payload2").getBytes();
    ...
    void testHexRoundtrip2(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (2 + j);
