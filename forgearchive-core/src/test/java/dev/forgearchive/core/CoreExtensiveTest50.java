...
class CoreExtensiveTest50 {

    @Test
    void testVarIntRoundtrip50() throws Exception {
        int v = 6351;
    ...
    @Test
    void testContentHash50() {
        byte[] data = ("payload50").getBytes();
    ...
    void testHexRoundtrip50(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (50 + j);
