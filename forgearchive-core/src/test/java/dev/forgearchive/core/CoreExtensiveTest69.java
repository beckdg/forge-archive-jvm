...
class CoreExtensiveTest69 {

    @Test
    void testVarIntRoundtrip69() throws Exception {
        int v = 8764;
    ...
    @Test
    void testContentHash69() {
        byte[] data = ("payload69").getBytes();
    ...
    void testHexRoundtrip69(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (69 + j);
