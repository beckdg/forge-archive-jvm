...
class CoreExtensiveTest13 {

    @Test
    void testVarIntRoundtrip13() throws Exception {
        int v = 1652;
    ...
    @Test
    void testContentHash13() {
        byte[] data = ("payload13").getBytes();
    ...
    void testHexRoundtrip13(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (13 + j);
