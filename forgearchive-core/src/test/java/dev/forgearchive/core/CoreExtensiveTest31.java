...
class CoreExtensiveTest31 {

    @Test
    void testVarIntRoundtrip31() throws Exception {
        int v = 3938;
    ...
    @Test
    void testContentHash31() {
        byte[] data = ("payload31").getBytes();
    ...
    void testHexRoundtrip31(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (31 + j);
