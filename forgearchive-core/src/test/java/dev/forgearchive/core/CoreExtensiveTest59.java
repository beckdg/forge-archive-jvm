...
class CoreExtensiveTest59 {

    @Test
    void testVarIntRoundtrip59() throws Exception {
        int v = 7494;
    ...
    @Test
    void testContentHash59() {
        byte[] data = ("payload59").getBytes();
    ...
    void testHexRoundtrip59(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (59 + j);
