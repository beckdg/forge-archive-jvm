...
class CoreExtensiveTest44 {

    @Test
    void testVarIntRoundtrip44() throws Exception {
        int v = 5589;
    ...
    @Test
    void testContentHash44() {
        byte[] data = ("payload44").getBytes();
    ...
    void testHexRoundtrip44(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (44 + j);
