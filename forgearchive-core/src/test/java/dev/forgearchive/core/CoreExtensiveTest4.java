...
class CoreExtensiveTest4 {

    @Test
    void testVarIntRoundtrip4() throws Exception {
        int v = 509;
    ...
    @Test
    void testContentHash4() {
        byte[] data = ("payload4").getBytes();
    ...
    void testHexRoundtrip4(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (4 + j);
