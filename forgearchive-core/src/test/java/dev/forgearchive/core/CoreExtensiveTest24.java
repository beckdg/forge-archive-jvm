...
class CoreExtensiveTest24 {

    @Test
    void testVarIntRoundtrip24() throws Exception {
        int v = 3049;
    ...
    @Test
    void testContentHash24() {
        byte[] data = ("payload24").getBytes();
    ...
    void testHexRoundtrip24(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (24 + j);
