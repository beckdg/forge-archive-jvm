...
class CoreExtensiveTest49 {

    @Test
    void testVarIntRoundtrip49() throws Exception {
        int v = 6224;
    ...
    @Test
    void testContentHash49() {
        byte[] data = ("payload49").getBytes();
    ...
    void testHexRoundtrip49(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (49 + j);
