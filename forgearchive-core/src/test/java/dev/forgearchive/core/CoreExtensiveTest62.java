...
class CoreExtensiveTest62 {

    @Test
    void testVarIntRoundtrip62() throws Exception {
        int v = 7875;
    ...
    @Test
    void testContentHash62() {
        byte[] data = ("payload62").getBytes();
    ...
    void testHexRoundtrip62(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (62 + j);
