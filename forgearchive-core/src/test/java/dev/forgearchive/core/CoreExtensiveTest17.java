...
class CoreExtensiveTest17 {

    @Test
    void testVarIntRoundtrip17() throws Exception {
        int v = 2160;
    ...
    @Test
    void testContentHash17() {
        byte[] data = ("payload17").getBytes();
    ...
    void testHexRoundtrip17(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (17 + j);
