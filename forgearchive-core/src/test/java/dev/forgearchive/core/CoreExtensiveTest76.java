...
class CoreExtensiveTest76 {

    @Test
    void testVarIntRoundtrip76() throws Exception {
        int v = 9653;
    ...
    @Test
    void testContentHash76() {
        byte[] data = ("payload76").getBytes();
    ...
    void testHexRoundtrip76(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (76 + j);
