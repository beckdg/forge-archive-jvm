...
class CoreExtensiveTest45 {

    @Test
    void testVarIntRoundtrip45() throws Exception {
        int v = 5716;
    ...
    @Test
    void testContentHash45() {
        byte[] data = ("payload45").getBytes();
    ...
    void testHexRoundtrip45(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (45 + j);
