...
class CoreExtensiveTest16 {

    @Test
    void testVarIntRoundtrip16() throws Exception {
        int v = 2033;
    ...
    @Test
    void testContentHash16() {
        byte[] data = ("payload16").getBytes();
    ...
    void testHexRoundtrip16(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (16 + j);
