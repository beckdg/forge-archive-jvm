...
class CoreExtensiveTest34 {

    @Test
    void testVarIntRoundtrip34() throws Exception {
        int v = 4319;
    ...
    @Test
    void testContentHash34() {
        byte[] data = ("payload34").getBytes();
    ...
    void testHexRoundtrip34(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (34 + j);
