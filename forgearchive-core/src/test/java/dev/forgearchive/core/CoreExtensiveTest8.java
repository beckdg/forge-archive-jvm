...
class CoreExtensiveTest8 {

    @Test
    void testVarIntRoundtrip8() throws Exception {
        int v = 1017;
    ...
    @Test
    void testContentHash8() {
        byte[] data = ("payload8").getBytes();
    ...
    void testHexRoundtrip8(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (8 + j);
