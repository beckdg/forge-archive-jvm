...
class CoreExtensiveTest15 {

    @Test
    void testVarIntRoundtrip15() throws Exception {
        int v = 1906;
    ...
    @Test
    void testContentHash15() {
        byte[] data = ("payload15").getBytes();
    ...
    void testHexRoundtrip15(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (15 + j);
