...
class CoreExtensiveTest7 {

    @Test
    void testVarIntRoundtrip7() throws Exception {
        int v = 890;
    ...
    @Test
    void testContentHash7() {
        byte[] data = ("payload7").getBytes();
    ...
    void testHexRoundtrip7(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (7 + j);
