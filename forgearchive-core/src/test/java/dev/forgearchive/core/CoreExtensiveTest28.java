...
class CoreExtensiveTest28 {

    @Test
    void testVarIntRoundtrip28() throws Exception {
        int v = 3557;
    ...
    @Test
    void testContentHash28() {
        byte[] data = ("payload28").getBytes();
    ...
    void testHexRoundtrip28(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (28 + j);
