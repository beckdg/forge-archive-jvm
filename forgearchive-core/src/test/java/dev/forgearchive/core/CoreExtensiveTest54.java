...
class CoreExtensiveTest54 {

    @Test
    void testVarIntRoundtrip54() throws Exception {
        int v = 6859;
    ...
    @Test
    void testContentHash54() {
        byte[] data = ("payload54").getBytes();
    ...
    void testHexRoundtrip54(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (54 + j);
