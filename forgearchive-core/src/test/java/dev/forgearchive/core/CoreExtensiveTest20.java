...
class CoreExtensiveTest20 {

    @Test
    void testVarIntRoundtrip20() throws Exception {
        int v = 2541;
    ...
    @Test
    void testContentHash20() {
        byte[] data = ("payload20").getBytes();
    ...
    void testHexRoundtrip20(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (20 + j);
