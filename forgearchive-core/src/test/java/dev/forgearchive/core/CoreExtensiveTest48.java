...
class CoreExtensiveTest48 {

    @Test
    void testVarIntRoundtrip48() throws Exception {
        int v = 6097;
    ...
    @Test
    void testContentHash48() {
        byte[] data = ("payload48").getBytes();
    ...
    void testHexRoundtrip48(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (48 + j);
