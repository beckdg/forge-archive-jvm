...
class CoreExtensiveTest30 {

    @Test
    void testVarIntRoundtrip30() throws Exception {
        int v = 3811;
    ...
    @Test
    void testContentHash30() {
        byte[] data = ("payload30").getBytes();
    ...
    void testHexRoundtrip30(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (30 + j);
