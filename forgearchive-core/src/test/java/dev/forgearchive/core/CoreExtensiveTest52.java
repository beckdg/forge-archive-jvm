...
class CoreExtensiveTest52 {

    @Test
    void testVarIntRoundtrip52() throws Exception {
        int v = 6605;
    ...
    @Test
    void testContentHash52() {
        byte[] data = ("payload52").getBytes();
    ...
    void testHexRoundtrip52(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (52 + j);
