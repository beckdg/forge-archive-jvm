...
class CoreExtensiveTest29 {

    @Test
    void testVarIntRoundtrip29() throws Exception {
        int v = 3684;
    ...
    @Test
    void testContentHash29() {
        byte[] data = ("payload29").getBytes();
    ...
    void testHexRoundtrip29(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (29 + j);
