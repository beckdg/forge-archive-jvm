...
class CoreExtensiveTest67 {

    @Test
    void testVarIntRoundtrip67() throws Exception {
        int v = 8510;
    ...
    @Test
    void testContentHash67() {
        byte[] data = ("payload67").getBytes();
    ...
    void testHexRoundtrip67(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (67 + j);
