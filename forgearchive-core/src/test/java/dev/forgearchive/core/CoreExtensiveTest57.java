...
class CoreExtensiveTest57 {

    @Test
    void testVarIntRoundtrip57() throws Exception {
        int v = 7240;
    ...
    @Test
    void testContentHash57() {
        byte[] data = ("payload57").getBytes();
    ...
    void testHexRoundtrip57(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (57 + j);
