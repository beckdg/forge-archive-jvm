...
class CoreExtensiveTest42 {

    @Test
    void testVarIntRoundtrip42() throws Exception {
        int v = 5335;
    ...
    @Test
    void testContentHash42() {
        byte[] data = ("payload42").getBytes();
    ...
    void testHexRoundtrip42(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (42 + j);
