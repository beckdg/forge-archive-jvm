...
class CoreExtensiveTest5 {

    @Test
    void testVarIntRoundtrip5() throws Exception {
        int v = 636;
    ...
    @Test
    void testContentHash5() {
        byte[] data = ("payload5").getBytes();
    ...
    void testHexRoundtrip5(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (5 + j);
