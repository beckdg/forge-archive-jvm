...
class CoreExtensiveTest3 {

    @Test
    void testVarIntRoundtrip3() throws Exception {
        int v = 382;
    ...
    @Test
    void testContentHash3() {
        byte[] data = ("payload3").getBytes();
    ...
    void testHexRoundtrip3(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (3 + j);
