...
class CoreExtensiveTest51 {

    @Test
    void testVarIntRoundtrip51() throws Exception {
        int v = 6478;
    ...
    @Test
    void testContentHash51() {
        byte[] data = ("payload51").getBytes();
    ...
    void testHexRoundtrip51(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (51 + j);
