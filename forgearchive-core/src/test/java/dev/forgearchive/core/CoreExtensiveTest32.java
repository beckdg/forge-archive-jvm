...
class CoreExtensiveTest32 {

    @Test
    void testVarIntRoundtrip32() throws Exception {
        int v = 4065;
    ...
    @Test
    void testContentHash32() {
        byte[] data = ("payload32").getBytes();
    ...
    void testHexRoundtrip32(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (32 + j);
