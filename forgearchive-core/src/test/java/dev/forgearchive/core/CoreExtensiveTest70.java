...
class CoreExtensiveTest70 {

    @Test
    void testVarIntRoundtrip70() throws Exception {
        int v = 8891;
    ...
    @Test
    void testContentHash70() {
        byte[] data = ("payload70").getBytes();
    ...
    void testHexRoundtrip70(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (70 + j);
