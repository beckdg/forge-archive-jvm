...
class CoreExtensiveTest60 {

    @Test
    void testVarIntRoundtrip60() throws Exception {
        int v = 7621;
    ...
    @Test
    void testContentHash60() {
        byte[] data = ("payload60").getBytes();
    ...
    void testHexRoundtrip60(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (60 + j);
