...
class CoreExtensiveTest22 {

    @Test
    void testVarIntRoundtrip22() throws Exception {
        int v = 2795;
    ...
    @Test
    void testContentHash22() {
        byte[] data = ("payload22").getBytes();
    ...
    void testHexRoundtrip22(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (22 + j);
