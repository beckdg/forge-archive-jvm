...
class CoreExtensiveTest75 {

    @Test
    void testVarIntRoundtrip75() throws Exception {
        int v = 9526;
    ...
    @Test
    void testContentHash75() {
        byte[] data = ("payload75").getBytes();
    ...
    void testHexRoundtrip75(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (75 + j);
