...
class CoreExtensiveTest53 {

    @Test
    void testVarIntRoundtrip53() throws Exception {
        int v = 6732;
    ...
    @Test
    void testContentHash53() {
        byte[] data = ("payload53").getBytes();
    ...
    void testHexRoundtrip53(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (53 + j);
