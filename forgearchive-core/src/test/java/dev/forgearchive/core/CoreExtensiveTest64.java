...
class CoreExtensiveTest64 {

    @Test
    void testVarIntRoundtrip64() throws Exception {
        int v = 8129;
    ...
    @Test
    void testContentHash64() {
        byte[] data = ("payload64").getBytes();
    ...
    void testHexRoundtrip64(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (64 + j);
