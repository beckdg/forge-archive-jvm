...
class CoreExtensiveTest10 {

    @Test
    void testVarIntRoundtrip10() throws Exception {
        int v = 1271;
    ...
    @Test
    void testContentHash10() {
        byte[] data = ("payload10").getBytes();
    ...
    void testHexRoundtrip10(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (10 + j);
