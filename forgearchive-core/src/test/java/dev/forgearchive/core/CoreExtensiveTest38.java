...
class CoreExtensiveTest38 {

    @Test
    void testVarIntRoundtrip38() throws Exception {
        int v = 4827;
    ...
    @Test
    void testContentHash38() {
        byte[] data = ("payload38").getBytes();
    ...
    void testHexRoundtrip38(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (38 + j);
