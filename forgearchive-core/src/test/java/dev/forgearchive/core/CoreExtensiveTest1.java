...
class CoreExtensiveTest1 {

    @Test
    void testVarIntRoundtrip1() throws Exception {
        int v = 128;
    ...
    @Test
    void testContentHash1() {
        byte[] data = ("payload1").getBytes();
    ...
    void testHexRoundtrip1(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (1 + j);
