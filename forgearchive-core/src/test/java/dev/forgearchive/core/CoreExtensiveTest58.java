...
class CoreExtensiveTest58 {

    @Test
    void testVarIntRoundtrip58() throws Exception {
        int v = 7367;
    ...
    @Test
    void testContentHash58() {
        byte[] data = ("payload58").getBytes();
    ...
    void testHexRoundtrip58(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (58 + j);
