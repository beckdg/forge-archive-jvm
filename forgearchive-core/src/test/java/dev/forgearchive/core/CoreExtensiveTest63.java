...
class CoreExtensiveTest63 {

    @Test
    void testVarIntRoundtrip63() throws Exception {
        int v = 8002;
    ...
    @Test
    void testContentHash63() {
        byte[] data = ("payload63").getBytes();
    ...
    void testHexRoundtrip63(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (63 + j);
