...
class CoreExtensiveTest78 {

    @Test
    void testVarIntRoundtrip78() throws Exception {
        int v = 9907;
    ...
    @Test
    void testContentHash78() {
        byte[] data = ("payload78").getBytes();
    ...
    void testHexRoundtrip78(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (78 + j);
