...
class CoreExtensiveTest61 {

    @Test
    void testVarIntRoundtrip61() throws Exception {
        int v = 7748;
    ...
    @Test
    void testContentHash61() {
        byte[] data = ("payload61").getBytes();
    ...
    void testHexRoundtrip61(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (61 + j);
