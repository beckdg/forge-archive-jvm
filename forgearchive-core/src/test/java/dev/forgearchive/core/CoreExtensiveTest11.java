...
class CoreExtensiveTest11 {

    @Test
    void testVarIntRoundtrip11() throws Exception {
        int v = 1398;
    ...
    @Test
    void testContentHash11() {
        byte[] data = ("payload11").getBytes();
    ...
    void testHexRoundtrip11(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (11 + j);
