...
class CoreExtensiveTest55 {

    @Test
    void testVarIntRoundtrip55() throws Exception {
        int v = 6986;
    ...
    @Test
    void testContentHash55() {
        byte[] data = ("payload55").getBytes();
    ...
    void testHexRoundtrip55(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (55 + j);
