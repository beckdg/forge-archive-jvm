...
class CoreExtensiveTest36 {

    @Test
    void testVarIntRoundtrip36() throws Exception {
        int v = 4573;
    ...
    @Test
    void testContentHash36() {
        byte[] data = ("payload36").getBytes();
    ...
    void testHexRoundtrip36(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (36 + j);
