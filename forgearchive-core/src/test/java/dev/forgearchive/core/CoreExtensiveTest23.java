...
class CoreExtensiveTest23 {

    @Test
    void testVarIntRoundtrip23() throws Exception {
        int v = 2922;
    ...
    @Test
    void testContentHash23() {
        byte[] data = ("payload23").getBytes();
    ...
    void testHexRoundtrip23(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (23 + j);
