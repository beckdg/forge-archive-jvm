...
class CoreExtensiveTest47 {

    @Test
    void testVarIntRoundtrip47() throws Exception {
        int v = 5970;
    ...
    @Test
    void testContentHash47() {
        byte[] data = ("payload47").getBytes();
    ...
    void testHexRoundtrip47(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (47 + j);
