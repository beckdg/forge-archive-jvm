...
class CoreExtensiveTest68 {

    @Test
    void testVarIntRoundtrip68() throws Exception {
        int v = 8637;
    ...
    @Test
    void testContentHash68() {
        byte[] data = ("payload68").getBytes();
    ...
    void testHexRoundtrip68(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (68 + j);
