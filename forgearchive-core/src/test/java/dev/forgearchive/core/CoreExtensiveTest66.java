...
class CoreExtensiveTest66 {

    @Test
    void testVarIntRoundtrip66() throws Exception {
        int v = 8383;
    ...
    @Test
    void testContentHash66() {
        byte[] data = ("payload66").getBytes();
    ...
    void testHexRoundtrip66(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (66 + j);
