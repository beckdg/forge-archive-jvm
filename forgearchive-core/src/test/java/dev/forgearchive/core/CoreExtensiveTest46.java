...
class CoreExtensiveTest46 {

    @Test
    void testVarIntRoundtrip46() throws Exception {
        int v = 5843;
    ...
    @Test
    void testContentHash46() {
        byte[] data = ("payload46").getBytes();
    ...
    void testHexRoundtrip46(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (46 + j);
