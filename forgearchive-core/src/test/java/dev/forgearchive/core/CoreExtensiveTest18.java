...
class CoreExtensiveTest18 {

    @Test
    void testVarIntRoundtrip18() throws Exception {
        int v = 2287;
    ...
    @Test
    void testContentHash18() {
        byte[] data = ("payload18").getBytes();
    ...
    void testHexRoundtrip18(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (18 + j);
