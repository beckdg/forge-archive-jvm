...
class CoreExtensiveTest71 {

    @Test
    void testVarIntRoundtrip71() throws Exception {
        int v = 9018;
    ...
    @Test
    void testContentHash71() {
        byte[] data = ("payload71").getBytes();
    ...
    void testHexRoundtrip71(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (71 + j);
