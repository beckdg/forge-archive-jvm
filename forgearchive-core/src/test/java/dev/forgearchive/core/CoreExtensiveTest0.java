...
class CoreExtensiveTest0 {

    @Test
    void testVarIntRoundtrip0() throws Exception {
        int v = 1;
    ...
    @Test
    void testContentHash0() {
        byte[] data = ("payload0").getBytes();
    ...
    void testHexRoundtrip0(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (0 + j);
