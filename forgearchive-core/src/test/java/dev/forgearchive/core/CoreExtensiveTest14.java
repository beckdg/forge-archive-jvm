...
class CoreExtensiveTest14 {

    @Test
    void testVarIntRoundtrip14() throws Exception {
        int v = 1779;
    ...
    @Test
    void testContentHash14() {
        byte[] data = ("payload14").getBytes();
    ...
    void testHexRoundtrip14(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (14 + j);
