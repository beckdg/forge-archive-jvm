...
class CoreExtensiveTest26 {

    @Test
    void testVarIntRoundtrip26() throws Exception {
        int v = 3303;
    ...
    @Test
    void testContentHash26() {
        byte[] data = ("payload26").getBytes();
    ...
    void testHexRoundtrip26(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (26 + j);
