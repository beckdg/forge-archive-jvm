...
class CoreExtensiveTest9 {

    @Test
    void testVarIntRoundtrip9() throws Exception {
        int v = 1144;
    ...
    @Test
    void testContentHash9() {
        byte[] data = ("payload9").getBytes();
    ...
    void testHexRoundtrip9(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (9 + j);
