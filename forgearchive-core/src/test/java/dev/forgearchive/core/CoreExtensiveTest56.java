...
class CoreExtensiveTest56 {

    @Test
    void testVarIntRoundtrip56() throws Exception {
        int v = 7113;
    ...
    @Test
    void testContentHash56() {
        byte[] data = ("payload56").getBytes();
    ...
    void testHexRoundtrip56(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (56 + j);
