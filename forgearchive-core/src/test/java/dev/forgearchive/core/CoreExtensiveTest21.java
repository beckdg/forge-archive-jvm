...
class CoreExtensiveTest21 {

    @Test
    void testVarIntRoundtrip21() throws Exception {
        int v = 2668;
    ...
    @Test
    void testContentHash21() {
        byte[] data = ("payload21").getBytes();
    ...
    void testHexRoundtrip21(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (21 + j);
