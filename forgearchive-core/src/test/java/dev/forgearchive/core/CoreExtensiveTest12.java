...
class CoreExtensiveTest12 {

    @Test
    void testVarIntRoundtrip12() throws Exception {
        int v = 1525;
    ...
    @Test
    void testContentHash12() {
        byte[] data = ("payload12").getBytes();
    ...
    void testHexRoundtrip12(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (12 + j);
