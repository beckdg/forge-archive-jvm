...
class CoreExtensiveTest73 {

    @Test
    void testVarIntRoundtrip73() throws Exception {
        int v = 9272;
    ...
    @Test
    void testContentHash73() {
        byte[] data = ("payload73").getBytes();
    ...
    void testHexRoundtrip73(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (73 + j);
