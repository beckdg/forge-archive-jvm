...
class CoreExtensiveTest79 {

    @Test
    void testVarIntRoundtrip79() throws Exception {
        int v = 10034;
    ...
    @Test
    void testContentHash79() {
        byte[] data = ("payload79").getBytes();
    ...
    void testHexRoundtrip79(int len) {
        byte[] data = new byte[len];
        for (int j = 0; j < len; j++) data[j] = (byte) (79 + j);
