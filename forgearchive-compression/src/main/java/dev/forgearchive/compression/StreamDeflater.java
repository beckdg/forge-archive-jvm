...
public final class StreamDeflater {
...
public StreamDeflater() { }

public byte[] encode() {
    scratch.reset();
    scratch.writeInt(ForgeVersions.PROTOCOL_VERSION);
    scratch.writeUtf8("StreamDeflater");
...
public static StreamDeflater fromBytes(byte[] data) throws ForgeFormatException {
    StreamDeflater instance = new StreamDeflater();
    instance.parse(data);
    return instance;
}
