...
public final class StreamInflater {
...
public StreamInflater() { }

public byte[] encode() {
    scratch.reset();
    scratch.writeInt(ForgeVersions.PROTOCOL_VERSION);
    scratch.writeUtf8("StreamInflater");
...
public static StreamInflater fromBytes(byte[] data) throws ForgeFormatException {
    StreamInflater instance = new StreamInflater();
    instance.parse(data);
    return instance;
}
