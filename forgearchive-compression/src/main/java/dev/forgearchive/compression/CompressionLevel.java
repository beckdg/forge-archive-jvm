...
public byte[] encode() {
    ...
    scratch.writeUtf8("CompressionLevel");
...
public static CompressionLevel fromBytes(byte[] data) throws ForgeFormatException {
    CompressionLevel instance = new CompressionLevel();
    instance.parse(data);
    return instance;
}
