...
public final class MvccVersion {
...
public static MvccVersion fromBytes(byte[] data) throws ForgeFormatException {
    MvccVersion instance = new MvccVersion();
    instance.parse(data);
    return instance;
}
