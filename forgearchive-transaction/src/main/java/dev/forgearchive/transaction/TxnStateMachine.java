...
public final class TxnStateMachine {
...
public TxnStateMachine() { }

public byte[] encode() {
    scratch.reset();
    scratch.writeInt(ForgeVersions.PROTOCOL_VERSION);
    scratch.writeUtf8("TxnStateMachine");
...
public static TxnStateMachine fromBytes(byte[] data) throws ForgeFormatException {
    TxnStateMachine instance = new TxnStateMachine();
    instance.parse(data);
    return instance;
}
