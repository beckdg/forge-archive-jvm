...
public byte[] encode() {
    ...
    scratch.writeUtf8("IsolationLevel");
...
public static IsolationLevel fromBytes(byte[] data) throws ForgeFormatException {
    IsolationLevel instance = new IsolationLevel();
    instance.parse(data);
    return instance;
}
