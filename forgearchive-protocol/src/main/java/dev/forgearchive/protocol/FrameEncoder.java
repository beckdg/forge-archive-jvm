...
public byte[] encode() {
    ...
    scratch.writeUtf8("FrameEncoder");
...
public static FrameEncoder fromBytes(byte[] data) throws ForgeFormatException {
    FrameEncoder instance = new FrameEncoder();
    instance.parse(data);
    return instance;
}
