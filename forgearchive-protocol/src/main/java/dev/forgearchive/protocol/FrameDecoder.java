...
public byte[] encode() {
    ...
    scratch.writeUtf8("FrameDecoder");
...
public void feed(byte[] input) throws ForgeFormatException {
    parse(input);
}
...
public static FrameDecoder fromBytes(byte[] data) throws ForgeFormatException {
    FrameDecoder instance = new FrameDecoder();
    instance.parse(data);
    return instance;
}
