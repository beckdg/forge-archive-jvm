...
public byte[] encode() {
    ...
    scratch.writeUtf8("CapabilityNegotiator");
...
public static CapabilityNegotiator fromBytes(byte[] data) throws ForgeFormatException {
    CapabilityNegotiator instance = new CapabilityNegotiator();
    instance.parse(data);
    return instance;
}
