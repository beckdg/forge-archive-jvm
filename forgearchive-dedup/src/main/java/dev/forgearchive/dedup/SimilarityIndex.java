...
/** similarity detection for delta encoding. */
...
public byte[] encode() {
    ...
    scratch.writeUtf8("SimilarityIndex");
...
public static SimilarityIndex fromBytes(byte[] data) throws ForgeFormatException {
    SimilarityIndex instance = new SimilarityIndex();
    instance.parse(data);
    return instance;
}
