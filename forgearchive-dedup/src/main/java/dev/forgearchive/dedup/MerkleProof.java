...
/** inclusion proof for merkle tree nodes. */
...
public static MerkleProof fromBytes(byte[] data) throws ForgeFormatException {
    MerkleProof instance = new MerkleProof();
    instance.parse(data);
    return instance;
}
