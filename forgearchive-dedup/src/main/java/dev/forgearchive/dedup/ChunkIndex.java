...
public static ChunkIndex fromBytes(byte[] data) throws ForgeFormatException {
    ChunkIndex instance = new ChunkIndex();
    instance.parse(data);
    return instance;
}
