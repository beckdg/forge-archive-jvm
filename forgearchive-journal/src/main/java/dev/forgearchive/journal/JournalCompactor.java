...
public static JournalCompactor fromBytes(byte[] data) throws ForgeFormatException {
    JournalCompactor instance = new JournalCompactor();
    instance.parse(data);
    return instance;
}
