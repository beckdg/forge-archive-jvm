...
public byte[] encode() {
    ...
    scratch.writeUtf8("CheckpointWriter");
...
public static CheckpointWriter fromBytes(byte[] data) throws ForgeFormatException {
    CheckpointWriter instance = new CheckpointWriter();
    instance.parse(data);
    return instance;
}
