...
/** index into journal by transaction id. */
...
public byte[] encode() {
    ...
    scratch.writeUtf8("JournalIndex");
...
public static JournalIndex fromBytes(byte[] data) throws ForgeFormatException {
    JournalIndex instance = new JournalIndex();
    instance.parse(data);
    return instance;
}
