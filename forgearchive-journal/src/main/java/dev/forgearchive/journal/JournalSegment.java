...
/** single journal segment reader/writer. */
...
public byte[] encode() {
    ...
    scratch.writeUtf8("JournalSegment");
...
public static JournalSegment fromBytes(byte[] data) throws ForgeFormatException {
    JournalSegment instance = new JournalSegment();
    instance.parse(data);
    return instance;
}
