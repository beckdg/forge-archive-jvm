...
public byte[] encode() {
    ...
    scratch.writeUtf8("FilterEvaluator");
...
public static FilterEvaluator fromBytes(byte[] data) throws ForgeFormatException {
    FilterEvaluator instance = new FilterEvaluator();
    instance.parse(data);
    return instance;
}
