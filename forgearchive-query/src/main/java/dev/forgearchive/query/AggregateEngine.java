...
public final class AggregateEngine {

/** aggregate functions engine. */
...
public byte[] encode() {
    ...
    scratch.writeUtf8("AggregateEngine");
...
public static AggregateEngine fromBytes(byte[] data) throws ForgeFormatException {
    AggregateEngine instance = new AggregateEngine();
    instance.parse(data);
    return instance;
}
