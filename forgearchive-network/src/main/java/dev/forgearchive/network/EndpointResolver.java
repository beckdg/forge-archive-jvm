...
public byte[] encode() {
    ...
    scratch.writeUtf8("EndpointResolver");
...
public static EndpointResolver fromBytes(byte[] data) throws ForgeFormatException {
    EndpointResolver instance = new EndpointResolver();
    instance.parse(data);
    return instance;
}
